...
repo, `.github`, or `ficentia-corporate-website` is expected to follow this document.
...
| `ficentia-corporate-website` — all | **en-US** | Technical presentation layer (content is sourced bilingually at build time) |
